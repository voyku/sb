...
inscertificate(){
	...
	yellow "经检测，之前已使用Acme-yg脚本申请过Acme域名证书：$(cat /root/cert/ca.log) "
...
instsllsingbox(){
	...
	curl -sL https://raw.githubusercontent.com/voyku/sb/main/version | awk -F "更新内容" '{print $1}' | head -n 1 > /etc/s-box/v
	clear
	red "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
...
acme(){
	bash <(curl -Lshttps://raw.githubusercontent.com/voyku/sb/main/acme.sh)
}
cfwarp(){
...
latestV=$(curl -sL https://raw.githubusercontent.com/voyku/sb/main/version| awk -F "更新内容" '{print $1}' | head -n 1)
